...
import {addNumber,substractNumbe} from '../modules/goodsCounter'
...
export default function GoodsCounter() {
    ...
    const onSubstractNumbe = () => dispatch(substractNumbe());
    ...
    return (
        <div>
            ...
            <div>
                <button type="button" onClick={onSubstractNumbe}>MINUS</button>
                <span>{goods}</span>
